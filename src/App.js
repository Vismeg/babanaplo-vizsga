  ...
  return (
    <Router>
      <nav className="navbar navbar-expand-sm navbar-dark bg-dark">
        <div style={{ fontFamily: "Bahnschrift Semibold", fontSize: '20px', lineHeight: 0.25 }} className="collapse navbar-collapse" id="navbarNav">
            ...
            localStorage.getItem("token") ?
              <ul className="navbar-nav">
                ...
                <li className="nav-item">
                  <NavLink to={'/szuletes'} className={({ isActive }) => "nav-link" + (isActive ? "active" : "")}>
                ...
                <li className="nav-item">
                  <NavLink to={'/'} onClick={logoutHandle} className={({ isActive }) => "nav-link" + (isActive ? "active" : "")}>
                    <span className="nav-link">Kilépés</span>
                  </NavLink>
                </li>
      ...
      <Routes>
        <Route path="/logout" element={<Kilepes />} />
        ...
        <Route path="/szuletes/" element={<SzuletesListPage />} />
